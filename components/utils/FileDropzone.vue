<template>
  <div v-if="!file">
    <div :class="['dropZone', dragging ? 'dropZone-over' : '']" @dragenter="dragging = true"
      ...
      <div class="dropZone-info" @drag="onChange">
        <span class="fa fa-cloud-upload dropzone-icon"></span>
        <span class="dropZone-title"><span>Click to upload</span> or drag and drop</span>
  ...
  <div v-else class="dropZone-uploaded">
    <div class="dropZone-uploaded-info">
      <span class="dropZone-title"><span>Uploaded</span></span>
